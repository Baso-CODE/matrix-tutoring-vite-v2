...
const LesPrivateSMAKecamatan = () => {
  ...
  const canonicalUrl = `${baseUrl}/bimbel-les-privat-sma-terbaik/kecamatan/${kecamatanSlug}`;

  // ⚡ SEO SUPER BOOSTED - Les Privat SMA Kecamatan ${nameCountry} | Matrix Tutoring

  const pageTitle = `🎓 Les Privat SMA di Kecamatan ${nameCountry} Terbaik #1 | Guru Datang ke Rumah & Online | Matrix Tutoring`;

  const descriptionContent = `Les Privat SMA terbaik di Kecamatan ${nameCountry} ✨ Dibimbing oleh guru profesional & berpengalaman. Fokus persiapan masuk PTN, Kedokteran, dan peningkatan nilai sekolah. Bisa les datang ke rumah atau online. Daftar sekarang di Matrix Tutoring!`;

  const ogTitle = `Les Privat SMA Kecamatan ${nameCountry} - Guru Profesional, Persiapan PTN & Kedokteran | Matrix Tutoring`;
  const ogDescription = `Matrix Tutoring hadir di Kecamatan ${nameCountry} dengan layanan Les Privat SMA terbaik. Belajar jadi lebih mudah dengan tutor ahli, metode interaktif, dan hasil belajar maksimal.`;

  const twitterTitle = `Les Privat SMA Kecamatan ${nameCountry} | Guru Datang ke Rumah & Online`;
  const twitterDescription = `Cari Les Privat SMA di Kecamatan ${nameCountry}? Matrix Tutoring solusinya! Guru datang ke rumah, les online fleksibel, dan bimbingan persiapan PTN terbaik. Yuk daftar sekarang!`;
          ...
          {`
            {
              ...
              "@graph": [
                {
                  ...
                  "itemListElement": [
                    ...
                    },
                    {
                      ...
                      "position": "3",
                      "item": {
                        "@id": "${baseUrl}/bimbel-les-privat-sma-terbaik/kecamatan/${kecamatanSlug}", 
                ...
                "url": "https://lesprivat.bimbelmatrix.com/bimbel-les-privat-sma-terbaik/kecamatan/${nameCountry}",
                ...
                "keywords": "les privat SMA Kecamatan ${nameCountry}, bimbel SMA Terbaik Kecamatan ${nameCountry}, guru datang ke rumah SMA, les Matematika, les SMA online Kecamatan ${nameCountry}, bimbingan belajar anak SMA"
                },
...

              {
               ...
               "url": "${canonicalUrl}",
               "name": "Les Privat SMA Kecamatan ${nameCountry} | Matrix Tutoring",
               "inLanguage": "id-ID",
               "description": "Matrix Tutoring menghadirkan Les Privat SMA terbaik di Kecamatan ${nameCountry}. Fokus pada peningkatan prestasi akademik, pemahaman materi, dan belajar menyenangkan.",
               "isPartOf": { "@id": "${baseUrl}" },
               "about": { "@id": "${canonicalUrl}#organization" },
               "mainEntity": {
               "@type": "Service",
               "name": "Les Privat SMA di Kecamatan ${nameCountry}",
...

            {
             ...
             "mainEntity": [
              ...
              {
                "@type": "Question",
                "name": "Apakah tersedia les privat online untuk siswa SMA di Kecamatan ${nameCountry}?",
                "acceptedAnswer": {
                "@type": "Answer",

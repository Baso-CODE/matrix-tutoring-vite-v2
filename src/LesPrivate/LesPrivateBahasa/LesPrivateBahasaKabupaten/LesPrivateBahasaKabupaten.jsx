...
const LesPrivateBahasaKabupaten = () => {
  ...
  const canonicalUrl = `${baseUrl}/kursus-bahasa-asing-terbaik/kabupaten/${kabupatenSlug}`;

  // Meta tag untuk Les Privat Bahasa Asing & Inggris
  const pageTitle = `🗣️ Les Privat Bahasa Asing & Inggris di Kabupaten ${nameCountry} - Kuasai TOEFL, IELTS & Percakapan | Matrix Tutoring`;
  const descriptionContent = `Tingkatkan kemampuan berbahasa asing Anda bersama tutor profesional Matrix Tutoring di Kabupaten ${nameCountry}. Belajar Bahasa Inggris, Korea, Jepang, Mandarin, Arab, dan lainnya. Fokus percakapan, grammar, TOEFL, IELTS, hingga ujian internasional. Bisa online atau guru datang ke rumah.`;

  // === Open Graph (Facebook & WhatsApp) ===
  const ogTitle = `Les Privat Bahasa Asing & Inggris di Kabupaten ${nameCountry} | Kursus TOEFL, IELTS & Conversation - Matrix Tutoring`;
  const ogDescription = `Matrix Tutoring menghadirkan kursus dan les privat bahasa asing terbaik di Kabupaten ${nameCountry}. Kuasai Bahasa Inggris, Korea, Jepang, Mandarin, dan Arab dengan metode interaktif dan fleksibel.`;

  const twitterTitle = `Les Privat Bahasa Asing Profesional di Kabupaten ${nameCountry} | Matrix Tutoring`;
  const twitterDescription = `Belajar bahasa Inggris, Korea, Jepang, Mandarin, dan Arab di Kabupaten ${nameCountry} bersama tutor ahli Matrix Tutoring. Fokus percakapan, TOEFL, IELTS, grammar & ujian internasional.`;

  const ogImage =
    "https://lesprivat.bimbelmatrix.com/images/whatsapp_footer.webp";
  const ogImageAlt = `Les Privat Bahasa Asing Inggris Kabupaten ${nameCountry} Matrix Tutoring`;
          ...
          {`
            {
              ...
              "@graph": [
                ...
                "description": "Les Privat Bahasa Asing & Inggris terbaik di Kabupaten ${nameCountry}. Kursus Bahasa Inggris, Korea, Jepang, Mandarin, dan Arab. Bimbingan TOEFL, IELTS, dan percakapan dengan tutor profesional. Bisa online atau guru datang ke rumah.",
                "url": "https://lesprivat.bimbelmatrix.com/kursus-bahasa-asing-terbaik/kabupaten/${kabupatenSlug}",
                ...
                "keywords": "les privat bahasa Inggris Kabupaten ${nameCountry}, kursus TOEFL Kabupaten ${nameCountry}, kursus IELTS Kabupaten ${nameCountry}, les bahasa Korea Kabupaten ${nameCountry}, les bahasa Jepang Kabupaten ${nameCountry}, les Mandarin Kabupaten ${nameCountry}, guru bahasa asing datang ke rumah, kursus bahasa asing online Kabupaten ${nameCountry}, les grammar dan speaking Kabupaten ${nameCountry}, bimbel bahasa Inggris profesional"
                },

                {
                  ...
                  "url": "${canonicalUrl}",
                  "name": "Les Privat Bahasa Asing Kabupaten ${nameCountry} | Matrix Tutoring",
                  "inLanguage": "id-ID",
                  "description": "Matrix Tutoring menghadirkan Les Privat Bahasa Asing (Inggris, Korea, Jepang, Mandarin, dll) terbaik di Kabupaten ${nameCountry}. Program intensif untuk meningkatkan TOEFL, IELTS, atau kemampuan percakapan.",
                  "isPartOf": { "@id": "${baseUrl}" },
...

                {
                  ...
                  "mainEntity": [
                    {
                      "@type": "Question",
                      "name": "Apakah Matrix Tutoring menyediakan guru privat datang ke rumah di Kabupaten ${nameCountry} untuk kursus Bahasa Asing?",
                      "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Ya, Matrix Tutoring menyediakan guru privat yang dapat datang langsung ke rumah siswa di Kabupaten ${nameCountry} untuk belajar berbagai Bahasa Asing. Jadwal bisa disesuaikan dengan kebutuhan belajar Anda."
                      }
                    },
                    {
                      "@type": "Question",
                      "name": "Apakah tersedia les privat online untuk Bahasa Asing (misalnya TOEFL/IELTS) di Kabupaten ${nameCountry}?",
                      "acceptedAnswer": {
                        "@type": "Answer",

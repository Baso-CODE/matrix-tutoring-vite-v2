...
const LesPrivateSMPKelurahan = () => {
  ...
  const canonicalUrl = `${baseUrl}/bimbel-les-privat-smp-terbaik/kelurahan/${kelurahanSlug}`;

  const pageTitle = `📚 Les Privat SMP di Kelurahan ${nameCountry} | Guru Profesional & Persiapan Masuk SMA | Matrix Tutoring`;
  const descriptionContent = `Les Privat SMP terbaik di Kelurahan ${nameCountry} bersama guru berpengalaman dari Matrix Tutoring. Fokus pada peningkatan nilai, penguasaan konsep, dan persiapan masuk SMA favorit. Belajar bisa online atau guru datang ke rumah.`;

  const ogTitle = `Les Privat SMP Kelurahan ${nameCountry} - Guru Terbaik & Strategi Efektif | Matrix Tutoring`;
  const ogDescription = `Matrix Tutoring menghadirkan les privat SMP terbaik di Kelurahan ${nameCountry}. Bimbingan intensif untuk prestasi akademik, ujian, dan kesiapan masuk SMA unggulan.`;
  const twitterTitle = `Les Privat SMP Terbaik di Kelurahan ${nameCountry} | Matrix Tutoring`;
  const twitterDescription = `Butuh guru privat SMP profesional di Kelurahan ${nameCountry}? Matrix Tutoring siap bantu tingkatkan nilai & semangat belajar anak Anda. Daftar sekarang!`;

  const ogImage =
    "https://lesprivat.bimbelmatrix.com/images/whatsapp_footer.webp";
  const ogImageAlt = `Les Privat SMP Terbaik Kelurahan ${nameCountry} Matrix Tutoring`;
          ...
          {`
            {
              ...
              "@graph": [
                {
                  ...
                  "itemListElement": [
                    ...
                    },
                    {
                      ...
                      "position": "2",
                      "item": {
                        "@id": "${baseUrl}/bimbel-les-privat-smp-terbaik", // URL program utama
                ...
                
                {
                 ...
                 "description": "Les Privat SMP terbaik di Kelurahan ${nameCountry} dengan guru berpengalaman. Fokus pada peningkatan prestasi akademik, persiapan ujian, dan strategi masuk SMA favorit. Jadwal fleksibel & bisa online maupun datang ke rumah.",
                 "url": "https://lesprivat.bimbelmatrix.com/bimbel-les-privat-smp-terbaik/kelurahan/${kelurahanSlug}",
                 ...
                 "https://www.facebook.com/matrixtutoring"
                  ...
                  "keywords": "les privat SMP Kelurahan ${nameCountry}, bimbel SMP Terbaik Kelurahan ${nameCountry}, guru datang ke rumah SMP, les Matematika, les SMP online Kelurahan ${nameCountry}, bimbingan belajar anak SMP"
                },
                
               {
                 ...
                 "url": "${canonicalUrl}",
                 "name": "Les Privat SMP Kelurahan ${nameCountry} | Matrix Tutoring",
                 "inLanguage": "id-ID",
                 "description": "Matrix Tutoring menghadirkan Les Privat SMP terbaik di Kelurahan ${nameCountry}. Fokus pada prestasi akademik, pemahaman materi, dan persiapan ujian masuk SMA favorit.",
                 "isPartOf": { "@id": "${baseUrl}" },
                 "about": { "@id": "${canonicalUrl}#organization" },
                 "mainEntity": {
                   "@type": "Service",
                   "name": "Les Privat SMP di Kelurahan ${nameCountry}",
             ...
             
             {
              ...
              {
                "@type": "Question",
                "name": "Apakah tersedia les privat online untuk siswa SMP di Kelurahan ${nameCountry}?",
                "acceptedAnswer": {
                "@type": "Answer",

...
const LesPrivateTKAKecamatan = () => {
  ...
  const canonicalUrl = `${baseUrl}/bimbel-tka-tes-kemampuan-akademik/kecamatan/${kecamatanSlug}`;

  // 🎯 SEO Meta Tags — versi Kecamatan
  const pageTitle = `🏆 Bimbel Les Privat TKA di Kecamatan ${nameCountry} - Bimbingan Intensif & Strategi Juara | Matrix Tutoring`;

  const descriptionContent = `Raih prestasi terbaik di TKA (Tes Kemampuan Akademik) bersama Matrix Tutoring di Kecamatan ${nameCountry}. Program les privat intensif dengan tutor profesional, latihan soal lengkap, dan strategi juara untuk menghadapi ujian dengan percaya diri.`;

  const ogTitle = `🏆 Bimbel Les Privat TKA di Kecamatan ${nameCountry} - Bimbingan Intensif & Strategi Juara | Matrix Tutoring`;
  const ogDescription = `Tingkatkan hasil TKA Anda bersama Matrix Tutoring di Kecamatan ${nameCountry}. Bimbingan privat intensif dengan guru berpengalaman dan materi terstruktur untuk hasil maksimal.`;

  const twitterTitle = `🏆 Bimbel Les Privat TKA di Kecamatan ${nameCountry} | Matrix Tutoring`;
  const twitterDescription = `Les Privat TKA (Tes Kemampuan Akademik) terbaik di Kecamatan ${nameCountry}. Bimbingan intensif, materi lengkap, dan strategi sukses dari tutor profesional Matrix Tutoring.`;
          ...
          {`
            {
              ...
              "description": "Les Privat dan Bimbel TKA (Tes Kemampuan Akademik) terbaik di Kecamatan ${nameCountry}. Belajar bersama tutor berpengalaman dengan program intensif dan latihan soal untuk hasil maksimal.",
              "url": "https://lesprivat.bimbelmatrix.com/bimbel-tka-tes-kemampuan-akademik/kecamatan/${nameCountry}",
              ...
              "keywords": "les privat TKA Kecamatan ${nameCountry}, bimbel TKA Terbaik Kecamatan ${nameCountry}, les persiapan UTBK Kecamatan ${nameCountry}, guru datang ke rumah TKA, les TKA online Kecamatan ${nameCountry}, bimbingan belajar masuk PTN"
              }, 

            {
              ...
              "url": "${canonicalUrl}",
              "name": "Les Privat TKA Kecamatan ${nameCountry} | Matrix Tutoring",
              "inLanguage": "id-ID",
              "description": "Matrix Tutoring menghadirkan Les Privat TKA (Tes Kemampuan Akademik) terbaik di Kecamatan ${nameCountry}. Fokus pada penguasaan materi TKA dan strategi mengerjakan soal untuk lolos UTBK/SNBT.",
              "isPartOf": { "@id": "${baseUrl}" },
              "about": { "@id": "${canonicalUrl}#organization" },
              "mainEntity": {
              "@type": "Service",
              "name": "Les Privat TKA di Kecamatan ${nameCountry}",
...

            {
              ...
              "mainEntity": [
               {
               "@type": "Question",
               "name": "Apakah Matrix Tutoring menyediakan guru datang ke rumah di Kecamatan ${nameCountry} untuk persiapan TKA?",
               "acceptedAnswer": {
                "@type": "Answer",
                "text": "Ya, Matrix Tutoring menyediakan guru privat yang dapat datang langsung ke rumah siswa di Kecamatan ${nameCountry} untuk fokus pada materi TKA. Jadwal bisa disesuaikan dengan kebutuhan persiapan UTBK/SNBT siswa."
                  }
                },
               {
                 "@type": "Question",
                 "name": "Apakah tersedia les privat online untuk TKA di Kecamatan ${nameCountry}?",
                 "acceptedAnswer": {
                 "@type": "Answer",

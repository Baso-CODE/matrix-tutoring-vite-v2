...
const LesPrivateTKAKabupaten = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setHeroData({
          heading: `Les Privat TKA di [LOKASI] - Persiapan Tes Kemampuan Akademik dengan Pendekatan Terstruktur`,
          image:
  ...
  const canonicalUrl = `${baseUrl}/bimbel-tka-tes-kemampuan-akademik/kabupaten/${kabupatenSlug}`;

  // 🎯 SEO Meta Tags — versi Kabupaten
  const pageTitle = `🏆 Les Privat TKA di Kabupaten ${nameCountry} - Program Intensif & Strategi Juara | Matrix Tutoring`;

  const descriptionContent = `Raih hasil maksimal di TKA (Tes Kemampuan Akademik) bersama Matrix Tutoring di Kabupaten ${nameCountry}. Program bimbingan intensif dengan guru profesional, latihan soal lengkap, dan strategi juara untuk menghadapi ujian dengan percaya diri.`;

  const ogTitle = `🏆 Les Privat TKA di Kabupaten ${nameCountry} - Program Intensif & Strategi Juara | Matrix Tutoring`;
  const ogDescription = `Tingkatkan skor TKA (Tes Kemampuan Akademik) Anda bersama Matrix Tutoring di Kabupaten ${nameCountry}. Belajar fokus, terarah, dan didampingi tutor berpengalaman.`;

  const twitterTitle = `🏆 Les Privat TKA di Kabupaten ${nameCountry} | Matrix Tutoring`;
  const twitterDescription = `Les Privat TKA (Tes Kemampuan Akademik) terbaik di Kabupaten ${nameCountry}. Dapatkan bimbingan intensif, latihan soal, dan strategi sukses dari tutor profesional Matrix Tutoring.`;
          ...
          {`
            {
                ...
                },
             {
              ...
              "description": "Les Privat dan Bimbel TKA (Tes Kemampuan Akademik) terbaik di Kabupaten ${nameCountry}. Belajar bersama tutor berpengalaman dengan program intensif dan latihan soal untuk hasil maksimal.",
              "url": "https://lesprivat.bimbelmatrix.com/bimbel-tka-tes-kemampuan-akademik/kabupaten/${nameCountry}",
              ...
              "keywords": "les privat TKA Kabupaten ${nameCountry}, bimbel TKA Terbaik Kabupaten ${nameCountry}, les persiapan UTBK Kabupaten ${nameCountry}, guru datang ke rumah TKA, les TKA online Kabupaten ${nameCountry}, bimbingan belajar masuk PTN"
              },

            {
              ...
              "url": "${canonicalUrl}",
              "name": "Les Privat TKA Kabupaten ${nameCountry} | Matrix Tutoring",
              "inLanguage": "id-ID",
              "description": "Matrix Tutoring menghadirkan Les Privat TKA (Tes Kemampuan Akademik) terbaik di Kabupaten ${nameCountry}. Fokus pada penguasaan materi TKA dan strategi mengerjakan soal untuk lolos UTBK/SNBT.",
              "isPartOf": { "@id": "${baseUrl}" },
              "about": { "@id": "${canonicalUrl}#organization" },
              "mainEntity": {
              "@type": "Service",
              "name": "Les Privat TKA di Kabupaten ${nameCountry}",
...

            {
              ...
              "mainEntity": [
               {
               "@type": "Question",
               "name": "Apakah Matrix Tutoring menyediakan guru datang ke rumah di Kabupaten ${nameCountry} untuk persiapan TKA?",
               "acceptedAnswer": {
                "@type": "Answer",
                "text": "Ya, Matrix Tutoring menyediakan guru privat yang dapat datang langsung ke rumah siswa di Kabupaten ${nameCountry} untuk fokus pada materi TKA. Jadwal bisa disesuaikan dengan kebutuhan persiapan UTBK/SNBT siswa."
                  }
                },
               {
                 "@type": "Question",
                 "name": "Apakah tersedia les privat online untuk TKA di Kabupaten ${nameCountry}?",
                 "acceptedAnswer": {
                 "@type": "Answer",
